...
export default {
  ...
  translation: {
    common: {
      ...
      atLeastOneBoardViewMustRemain: 'Mindestens eine Boardansicht muss sichtbar bleiben.',
      attachment: 'Anhang',
      attachments: 'Anhänge',
      ...
      calendar: 'Kalender',
      calendarNavigation_next: 'Nächster Zeitraum',
      calendarNavigation_prev: 'Vorheriger Zeitraum',
      calendarNavigation_today: 'Zum heutigen Datum',
      ...
      editDateRange_title: 'Zeitraum bearbeiten',
      ...
      invalidDateRange: 'Der Start darf nicht nach dem Fälligkeitsdatum liegen.',
      kanban: 'Kanban',
      labels: 'Labels',
      language: 'Sprache',
      ...
      manageViews_title: 'Ansichten verwalten',
      ...
      selectMonthAndYear_title: 'Monat und Jahr auswählen',
      ...
      today: 'Heute',
      title: 'Titel',
      toggleBoardViewVisibility: '{{view}} in der Boardansicht-Auswahl anzeigen',
      trash: 'Papierkorb',
