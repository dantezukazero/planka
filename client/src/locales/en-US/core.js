...
export default {
  ...
  translation: {
    common: {
      ...
      atLeastOneBoardViewMustRemain: 'At least one board view must remain visible.',
      ...
      calendar: 'Calendar',
      calendarNavigation_next: 'Next period',
      calendarNavigation_prev: 'Previous period',
      calendarNavigation_today: 'Go to today',
      ...
      invalidDateRange: 'The start must not be after the due date.',
      kanban: 'Kanban',
      labels: 'Labels',
      language: 'Language',
      ...
      managers: 'Managers',
      manageViews_title: 'Manage Views',
      ...
      selectMonthAndYear_title: 'Select Month and Year',
      ...
      today: 'Today',
      title: 'Title',
      toggleBoardViewVisibility: 'Show {{view}} in the board view switcher',
      trash: 'Trash',
